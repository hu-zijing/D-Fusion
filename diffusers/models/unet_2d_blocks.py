...
class UNetMidBlock2D(nn.Module):
    ...
    def forward(self, hidden_states: torch.FloatTensor, temb: Optional[torch.FloatTensor] = None) -> torch.FloatTensor:
        ...
        for attn, resnet in zip(self.attentions, self.resnets[1:]):
            attn_probs_0 = None
            if attn is not None:
                hidden_states, attn_probs_0 = attn(hidden_states, temb=temb)
            hidden_states = resnet(hidden_states, temb)
            attn_probs.append(attn_probs_0)
...
class UNetMidBlock2DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        attn_probs_self = []
        attn_probs_cross = []
        for i, attn, resnet in zip(range(len(self.attentions)), self.attentions, self.resnets[1:]):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states, attn_probs_self_0, attn_probs_cross_0 = attn(
                    hidden_states,
                    ...
                    return_dict=False,
                    given_attn_map = given_attn_map[i] if given_attn_map is not None else given_attn_map, 
                ...
                attn_probs_self.append(attn_probs_self_0)
        ...
        return hidden_states, attn_probs_self, attn_probs_cross
...
class CrossAttnDownBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, output_states, attn_probs_self, attn_probs_cross
...
class DownBlock2D(nn.Module):
    ...
    def forward(
        ...
        return hidden_states, output_states, None
...
class CrossAttnUpBlock2D(nn.Module):
    ...
    def forward(
        ...
        for i, resnet, attn in zip(range(len(self.attentions)), self.resnets, self.attentions):
            # pop res hidden states
            res_hidden_states = res_hidden_states_tuple[-1]
            res_hidden_states_tuple = res_hidden_states_tuple[:-1]
